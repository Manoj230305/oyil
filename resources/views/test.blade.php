...
<link rel="stylesheet" href="{{ asset('css/imgcaro.css') }}">
  ...
  <body>
	...
	<nav class="glass-nav">
		<div class="glass-nav-container">
			<div class="glass-logo-wrapper">
				<a href="index.html" class="glass-logo-link" >
				  <span class="flaticon-camera-shutter"></span>
				  <span class="glass-logo-text">Oyil <span class="glass-logo-sub">Photography</span></span>
				</a>
			</div>  
		  <button class="glass-toggle" id="glassToggle">&#9776;</button>
		  <ul class="glass-links" id="glassMenu">
	...
	<section id="home" class="hero-wrap js-fullheight">
		<!-- <div class="logo-top-left">
			<h1 class="logo">
				<a href="index.html"><span class="flaticon-camera-shutter"></span> Oyil <small>Photography</small></a>
			</h1>
		</div> -->
		<div class="swiper-container">
			<div class="swiper-wrapper">
						...
						<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
							<div class="col-lg-7 ftco-animate d-flex align-items-center">
								<div class="text text-center">
									<!-- <h1 class="logo"><a href="index.html"><span class="flaticon-camera-shutter"></span> Oyil Photography</a></h1> -->
									<!-- <h1 class="mb-4">We Make <br>Something Great</h1> -->
									<!-- <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia.</p> -->
									<!-- <p class="mt-0"><a href="#" class="btn-custom">Contact us <span class="ion-ios-arrow-round-forward"></span></a></p> -->
								</div>
							</div>
						</div>
					</div>
				...
				<!-- Slide 2 -->
				<div class="swiper-slide" style="background-image: url('/images/m2.jpg');">
					<div class="overlay"></div>
					<div class="container">
						<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
							<div class="col-lg-7 ftco-animate d-flex align-items-center">
								<!-- <div class="text text-center">
									<h1 class="mb-4">Capture Life's Best Moments</h1>
									<p class="mb-4">Experience the magic of photography with a professional touch.</p>
									<p class="mt-5"><a href="#" class="btn-custom">Explore <span class="ion-ios-arrow-round-forward"></span></a></p>
								</div> -->
							</div>
						</div>
					</div>
				...
				<!-- Slide 3 -->
				<div class="swiper-slide" style="background-image: url('/images/m3.jpg');">
					<div class="overlay"></div>
					<div class="container">
						<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
							<div class="col-lg-7 ftco-animate d-flex align-items-center">
								<!-- <div class="text text-center">
									<h1 class="mb-4">Let's Tell a Story Together</h1>
									<p class="mb-4">Every picture speaks a thousand words—let's create memories that last forever.</p>
									<p class="mt-5"><a href="#" class="btn-custom">Get Started <span class="ion-ios-arrow-round-forward"></span></a></p>
								</div> -->
							</div>
						</div>
					</div>
				...
				<!-- Slide 4 -->
				<div class="swiper-slide" style="background-image: url('/images/m1.jpeg');">
					<div class="overlay"></div>
					<div class="container">
						<div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
							<div class="col-lg-7 ftco-animate d-flex align-items-center">
								<div class="text text-center">
									<h1 class="mb-4">Creative Photography for You</h1>
									<p class="mb-4">We transform ideas into stunning visuals with a touch of creativity.</p>
									<p class="mt-5"><a href="#" class="btn-custom">Learn More <span class="ion-ios-arrow-round-forward"></span></a></p>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- Navigation Arrows -->
			<div class="swiper-button-next" style="color: blanchedalmond;"></div>
			<div class="swiper-button-prev" style="color: blanchedalmond;"></div>
			...
			<div class="container">
				<div class="row d-flex no-gutters">
					<div class="col-md-6 col-lg-6 d-flex">
						<div class="img-about img d-flex align-items-center w-100">
							<img src="images/ban.jpg" alt="Oyil Photography" class="img-fluid rounded shadow">
						</div>
					</div>
					
					<div class="col-md-6 col-lg-6 pl-md-5">
				<div class="heading-section ftco-animate">
					<h2 class="mb-4">Oyil Photography</h2>
					<p>What does your mind conjure up when I say the word wedding? Celebration, happy faces, flowers, dhol-nagada-shehnai, the realisation of a thousand childhood dreams, vibrant colours, proud extended families, and love all around! Undoubtedly, you want these infinite memories to be arrested and treasured for a lifetime.</p>
					<p>Our mission is simple: to capture the essence of our clients' stories, relationships, and experiences through beautiful, timeless photography. Whether it's a wedding, family portrait, or milestone event, we're committed to delivering images that bring joy, warmth, and nostalgia.
					</p>
					...
					<blockquote class="blockquote mt-3">
						<p class="mb-2">“Life is like a camera. Focus on what's important, capture the good times, develop from the negatives.”
						</p>
					</blockquote>
				</div>
				</div>
	...
	<!-- Start Gallery Section -->
		<section id="work" class="ftco-section">
			<div class="container">
				<div class="row justify-content-center">
				  <div class="col-md-8 heading-section text-center ftco-animate pb-5 position-relative">
					<h2 class="mb-4">Gallery</h2>
					<!-- <div class="d-flex justify-content-end">
						<a href="gallery.html" class="btn btn-outline-light btn-sm mt-3 me-2" style="margin-right: -240px;">View All</a>
					</div> -->

					<!-- Filter Buttons -->
					<div class="row justify-content-center text-center mb-4">
					  <div class="col-6 col-sm-3 mb-2">
						<div class="category-icon" onclick="filterGallery('prewedding')">
						  <img src="images/m2.jpg" alt="Prewedding" />
						  <p>Prewedding</p>
						</div>
					  </div>
					  <div class="col-6 col-sm-3 mb-2">
						<div class="category-icon" onclick="filterGallery('wedding')">
						  <img src="images/m3.jpg" alt="Wedding" />
						  <p>Wedding</p>
						</div>
					  </div>
					  <div class="col-6 col-sm-3 mb-2">
						<div class="category-icon" onclick="filterGallery('baby')">
						  <img src="images/m1.jpeg" alt="Baby Shoot" />
						  <p>Baby Shoot</p>
						</div>
					  </div>
					  <div class="col-6 col-sm-3 mb-2">
						<div class="category-icon" onclick="filterGallery('modelling')">
						  <img src="images/model-5.jpg" alt="Modelling" />
						  <p>Modelling</p>
						</div>
					  </div>
					  <!-- View All Button -->
			...
			<div class="container-fluid px-md-0">
			  <div class="row no-gutters" id="gallery">
				...
				<!-- Prewedding Images -->
				<div class="col-md-4 ftco-animate gallery-item" data-category="prewedding">
				  <div class="model img d-flex align-items-end" style="background-image: url(images/model-1.jpg);">
					<a href="images/bab1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				...
				<!-- Wedding -->
				<div class="col-md-4 ftco-animate gallery-item" data-category="wedding">
				  <div class="model img d-flex align-items-end" style="background-image: url(images/m1.jpeg);">
					<a href="images/m1.jpeg" class="icon image-popup d-flex justify-content-center align-items-center">
					  <span class="icon-expand"></span>
					</a>
				  </div>
				</div>
				...
				<!-- Baby -->
				<div class="col-md-4 ftco-animate gallery-item" data-category="baby">
				...
				<!-- Modelling -->
				<div class="col-md-4 ftco-animate gallery-item" data-category="modelling">
				...
				<!-- Add rest of your images below with appropriate data-category -->
				<div class="col-md-4 ftco-animate gallery-item" data-category="modelling">
				...
				<div class="col-md-4 ftco-animate gallery-item" data-category="wedding">
				  <div class="model img d-flex align-items-end" style="background-image: url(images/m5.jpg);">
					<a href="images/m5.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
					  <span class="icon-expand"></span>
					</a>
				  </div>
				</div>
			...
			<div class="container mt-4">
				<div class="d-flex justify-content-center">
				  <a href="gallery.html" class="btn-grad">View All</a>
				</div>
			</div>
		...
		<section id="services" class="ftco-section">
			<div class="container">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="media block-6 services d-block ftco-animate">
									...
									<div class="media-body">
										<h3 class="heading mb-2"> Event Photography</h3><br>
										<p>Capturing timeless memories from weddings, parties, and special occasions.
										</p>
									</div>
								</div> 
							</div>
							<div class="col-md-4">
								...
								<div class="icon"><span class="flaticon-video-player"></span></div>
									<div class="media-body">
										<h3 class="heading mb-2">Portrait &amp; Studio Photography</h3>
										<p>Professional indoor shoots for individuals, families, and milestone moments.</p>
									</div>
							    </div> 
							</div>
							<div class="col-md-4">
								...
								<div class="icon"><span class="flaticon-video-player-1"></span></div>
									<div class="media-body">
									<h3 class="heading mb-2">Commercial &amp; Product Photography</h3>
									<p>High-quality visuals tailored to elevate your brand, business, or product.
									</p>
								</div>
							</div> 
						</div>
				...
				<div class="col-md-3 d-flex align-items-stretch">
					<div class="img w-100" style="background-image: url(images/nnp.png);"></div>
				</div>
			</div>
			<!-- <div class="row progress-circle pt-md-5">
				<div class="col-md-7 order-md-last py-md-5">
					...
					<div class="img w-100" style="background-image: url(images/abp.png);"></div>
				</div>
				</div>
			</div> -->
		</section>
		...
		<section class="ftco-section testimony-section" id="testimony">
			<div class="container">
            ...
            <div class="carousel-testimony owl-carousel">
				<div class="item">
					<div class="testimony-wrap p-4 pb-5">
					  <div class="user-img mb-4" style="background-image: url(images/n3.jpg)">
					  ...
					  <div class="text">
						...
						<div class="pl-5 d-flex justify-content-between align-items-center mt-4">
							<div>
							  <p class="name mb-0">Garreth Smith</p>
							  <span class="position">CEO</span>
							</div>
							<a href="story.html" class="btn-grad btn-small" style="color: rgb(13, 10, 28);">Read More</a>
						</div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/n2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/n4.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-4" style="background-image: url(images/n1.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
		...
		<!-- Start Our Branches  -->
		<section class="ftco-section contact-section" id="branches">
			<div class="container">
			  <div class="row justify-content-center mb-4">
				<div class="col-md-8 heading-section text-center ftco-animate">
				  <h2 class="mb-4">Our Other Branches</h2>
				</div>
			  </div>
			  ...
			  <div class="row">
				...
				<div class="col-md-6 mb-5">
				  <div class="row">
					<div class="col-md-6 d-flex ftco-animate">
					  <div class="align-self-stretch box text-center p-4 w-100">
						<div class="icon d-flex align-items-center justify-content-center">
						  <span class="icon-map-signs"></span>
						</div>
						<h3 class="mb-4">Address</h3>
						<p>	Sri Thangam Construction Complex, New, Housing Board, <br> Sivakasi, Tamil Nadu - 626124</p>
					  </div>
					</div>
					<div class="col-md-6 d-flex ftco-animate">
					  <div class="align-self-stretch box text-center p-4 w-100">
						...
						<p><a href="tel:+918807775335">+918807775335</a></p>
						<p><a href="tel:+917200972631">+917200972631</a></p>
					  </div>
					</div>
				  </div>
				  <div class="row mt-3">
					<div class="col-12 ftco-animate">
					  <iframe
						src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15741.785711624221!2d77.762737!3d9.469842!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b06cf86ba2e6685%3A0xf7d9b52fd5486d49!2sS%20Studio!5e0!3m2!1sen!2sin!4v1744120804469!5m2!1sen!2sin"
						width="100%" 
						height="300" 
						frameborder="0" 
				...
				<div class="col-md-6 mb-5">
				  <div class="row">
					<div class="col-md-6 d-flex ftco-animate">
					  <div class="align-self-stretch box text-center p-4 w-100">
						...
						<p>4th Street Senbaga nagar, Illuppaiyurani Road, Puthukiramam Main Road, Kovilpatti, Thoothukudi - 628502</p>
					  </div>
					</div>
					<div class="col-md-6 d-flex ftco-animate">
					  <div class="align-self-stretch box text-center p-4 w-100">
				  ...
				  <div class="row mt-3">
					<div class="col-12 ftco-animate">
					  <iframe
					  	src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.88!2d77.8868167!3d9.1878833!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b06c1f4e4e4e4e4%3A0x4e4e4e4e4e4e4e4e!2sYour%20Destination%20Name!5e0!3m2!1sen!2sin!4v1640000000000!5m2!1sen!2sin"
					  	width="100%" 
						height="300" 
						frameborder="0" 
						style="border:0; border-radius: 12px;" 
			...
			<div class="container text-center">
			  <div class="row">
				<div class="col-md-12">
				  ...
				  <p class="mb-3">
					<a href="#" target="_blank" rel="noopener noreferrer">Follow Us On</a>
				  </p>
		  
				  <ul class="ftco-footer-social list-inline p-0 mb-0">
					<li class="list-inline-item ftco-animate">
