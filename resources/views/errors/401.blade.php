...
<title>401 | OyilPhotography</title>
...
<div class="container">
  ...
  <div class="content">
    <div class="error">
      ...
      <span class="digit" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">1</span>
    </div>


    <div class="text">
      <h1>Unauthorized </h1>
      <p>You are restricted to access this area</p>
    </div>
